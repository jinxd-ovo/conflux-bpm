...
(function ($) {
    ...
    */      
    ...
    '<div><div class="editable-input"></div><div class="editable-buttons" style="display:none;"></div></div>'+
    ...
    $.extend($.fn.editableform.Constructor.prototype, {
        ...
        initInput: function() {  
        	...
        	if(this.input.type == "select"){
        		this.input.$input.attr("onchange",'javascript:$(this).closest("form").find(".editable-submit").trigger("click")');
        	}
