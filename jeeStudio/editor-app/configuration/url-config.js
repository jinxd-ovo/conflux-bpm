...
KISBPM.URL = {
    ...
    getStencilSet2: function() {
        return ACTIVITI.CONFIG.contextRoot + '/editor/stencilset2?version=' + Date.now();
    },
    putModel: function(modelId) {
        return ACTIVITI.CONFIG.contextRoot + '/model/' + modelId + '/save';
    },
    putTz: function(modelId) {
    	return ACTIVITI.AUTO.contextAuto + '/tiaozheng/' + modelId;
    }
};